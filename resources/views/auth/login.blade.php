    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            ...
            <div class="auth-box row">
                ...
                <div class="col-lg-5 col-md-7 custom-bg">
                    <div class="p-3">
                        <div class="text-center">
                            <!-- Panggil Lottie Player CDN -->
                           <script src="{{ asset('js/lottie-player.js') }}"></script>

                            <!-- Animasi Lottie ngopi -->
                            <lottie-player src="{{ asset('animations/lotie.json') }}" background="transparent" speed="1"
                                style="width: 200px; height: 200; margin: 0 auto;" loop autoplay>
                            </lottie-player>
                        </div>
                        ...
                        <form class="mt-4" method="POST" action="{{ route('login') }}" id="loginForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 text-center" id="buttonContainer">
                                    <button type="submit" class="btn btn-block btn-dark" id="submitBtn">Sign In</button>
                                </div>

                                <div class="col-lg-12 text-center mt-3" id="spinnerContainer" style="display:none;">
                                    <!-- Spinner Lottie -->
                                    <lottie-player src="{{ asset('animations/spinner.json') }}" background="transparent"
                                        speed="1" style="width: 100px; height: 100px; margin: 0 auto;" loop
