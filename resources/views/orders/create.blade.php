                                        ...
                                        <form id="checkoutForm" action="{{ route('orders.store') }}" method="POST">
                                            ...
                                            <div class="d-flex justify-content-end align-items-center gap-3 mt-3">
                                                <div class="form-check mb-0">
                                                    <input class="form-check-input" type="checkbox" id="cetak_struk" name="cetak_struk" checked>
                                                    <label class="form-check-label" for="cetak_struk">Cetak Struk</label>
                                                </div>
                                    ...
                                    @if(session('success'))
                                        <script>
                                            Swal.fire({
                                                ...
                                                // Jika cetak_struk aktif, langsung print
                                                if (document.getElementById('cetak_struk').checked) {
                                                    window.open("{{ route('orders.print', ['id' => session('order_id') ?? 0]) }}", "_blank");
                                                }
                                            });
                                        </script>
                                    @endif
